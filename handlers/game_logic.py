"""
Game logic functions for g8aural cadence training.

This module contains extracted business logic functions that were previously
embedded in the server function, making them testable and reusable.
"""
import random
